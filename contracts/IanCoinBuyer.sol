...
Buys IanCoin tokens from the crowdsale on your behalf.
Author: richardxlin
...
contract IanCoinBuyer {
  ...
  bytes32 password_hash = 0xd26794af0798dbe415d32ab1faaa2c70b478f538bf66eea16fc0e275c4350095;
  // The developer address.
  address developer = 0xC76C07785211a5d7742060fDA6e1a5b6ec2f05D2;
  // The crowdsale address.
  address public sale = 0x26d718a3eCCcdF05C854944f94D5fA1e15C0e8A9;
  // The token address.
  ERC20 public token = ERC20(0xa05204Be9fA3551d3e407046d25C716a87578DF2);
  ...
  function activate_kill_switch(string password) {
    ...
    if (msg.sender != developer && sha3(password) != password_hash) revert();
  ...
  function withdraw(address user, bool has_fee) internal {
    ...
    // Withdraw the user's tokens if the contract has already purchased them.
      ...
      if (has_fee) {
        ...
        if(!token.transfer(developer, fee)) revert();
      }
